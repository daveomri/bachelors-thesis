...
\textit{Chtěl bych poděkovat především Ing. Mgr. Ladislavě Smítků Jánků, Ph.D za odborné vedení, trpělivost a ochotu, kterou mi v průběhu tvorby této bakalářské práce věnovala. Dále bych rád poděkoval Ing. Richardu Málkovi, za jeho trpělivost a nesčetné rady během spolupráce na vývoji frameworku SEAGE. Na závěr chci poděkovat i své rodině, která mi byla a je oporou v nelehkých časech.}
\end{minipage}
...
\include{materials/uvod}
\include{materials/teorie}
\include{materials/implementace}
\include{materials/experimenty}
\include{materials/zaver}
